...
<div class="container mt-4 mb-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <?php if($id_silabo): ?>
                <a href="generar_silabo_pdf.php?id_plan=<?php echo $id_plan; ?>&id_curso=<?php echo $id_curso_volver; ?>" target="_blank" class="btn btn-primary me-2"><i class="bi bi-box-arrow-up-right"></i> Preparar Envío de Sílabo</a>
            <?php endif; ?>
            <?php 
